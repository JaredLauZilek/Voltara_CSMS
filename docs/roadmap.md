...
- [ ] **Phase 3 — Tariffs, billing math, CDRs, reports** (~2–3 wk) · design 21 Sep 2026 — [docs/phase3-billing-design.md](phase3-billing-design.md), ADR-0005 (Stripe), ADR-0006 (OCPI-shaped tariffs/CDRs) · **steps 1–3 done 21 Sep** (schema, cost engine, gateway snapshot/CDR/idle/webhooks) · next: 4 tariff admin UI, 5 CDRs/reports/exports/documents, 6 canary
